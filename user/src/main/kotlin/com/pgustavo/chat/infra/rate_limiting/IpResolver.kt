package com.pgustavo.chat.infra.rate_limiting

import com.pgustavo.chat.infra.config.NginxConfig
...
class IpResolver(
    ...
    companion object {
       ...
       private val INVALIDS_IPS = listOf(
           "unknown",
           "unavailable",
           "0.0.0.0",
           "::",
    ...
    private fun validateAndNormalizeIp(ip: String, headerName: String, proxyIp: String): String? {
        ...
        if (trimmedIp.isBlank() || INVALIDS_IPS.contains(trimmedIp)) {
